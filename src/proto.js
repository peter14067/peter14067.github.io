...
<div className="App"  >
    ...
    <div style={{width:"50vw",marginLeft:"5px",height:"auto"}}>
    <div style={{float:"left",display:"flex",marginLeft:"4px",display:"flex",display:"inline-block",textAlign:"center",background:"#ebecf0 ",width:"20%",padding:"1%",borderRadius:'10px',verticalAlign:"middle"}}>
    { BsFillArrowLeftCircleFill } 
<p style={{fontSize:"20px",textAlign:"center",color:"black"}}>未完成任務</p>
    ...
    <div style={{float:"left",display:"flex",display:"inline-box",marginLeft:"1.5vw",background:"#ebecf0 ",width:"19%",padding:"1%",verticalAlign:"middle",borderRadius:'10px'}}>
...
{todos1.map((todo1,index)=>(
        <div style={{backgroundColor:"white",borderRadius:'10px',display:"flex",justifyContent:"space-between",marginBottom:"10px"}}>
          ...
          <button onClick={()=>notfinish1(index)}style={{backgroundColor:"white ",border:"none",verticalAlign:"middle"}}>
            ...
            <img src={Back} style={{width:"20px",border:"none",marginLeft:"auto"}} /></button>
...
<div style={{marginLeft:"1.5vw",float:"left",background:"#ebecf0 ",width:"19%",padding:"1%",verticalAlign:"middle",borderRadius:'10px'}}>
...
{todos2.map((todo2,index)=>(
        <div style={{backgroundColor:"white",borderRadius:'10px 10px',display:"flex",justifyContent:"space-between",marginBottom:"10px"}}>
          ...
          <button onClick={()=>del2(index)}style={{backgroundColor:"white ",border:"none",verticalAlign:"middle"}}>
            ...
            <img src={Del}  style={{width:"20px",border:"none"}} /></button>
          </div>
